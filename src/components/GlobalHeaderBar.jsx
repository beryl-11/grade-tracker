...
function GlobalHeaderBar() {
    ...
    <div className="header-btn-wrapper flex-container">
      <button type="button" className="global-header-btn modal-open-btn" id="settings-btn" data-href="settings-modal" aria-label="Settings">
      ...
      <button type="button" className="global-header-btn" id="sign-in-btn" aria-label="Sign In">
